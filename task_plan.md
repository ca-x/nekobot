...
- [ ] gateway control plane hardening
  - 当前已完成切片：`gateway.allowed_ips`、`gateway.rate_limit_per_minute`、控制面 `admin/owner` role gate；下一批仍不混入过多变更，优先考虑 pairing、finer scope 中的单一最小切片。

...
func (_c *MembershipCreate) SetTenantID(v string) *MembershipCreate {
...
func (_c *MembershipCreate) SetEnabled(v bool) *MembershipCreate {
	_c.mutation.SetEnabled(v)
	return _c
}

// SetNillableEnabled sets the "enabled" field if the given value is not nil.
func (_c *MembershipCreate) SetNillableEnabled(v *bool) *MembershipCreate {
	if v != nil {
		_c.SetEnabled(*v)
	}
	return _c
...
func (_c *MembershipCreate) SetNillableID(v *string) *MembershipCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
func (_c *MembershipCreate) SetTenant(v *Tenant) *MembershipCreate {
...
func (_c *MembershipCreate) check() error {
	...
	if _, ok := _c.mutation.Enabled(); !ok {
		return &ValidationError{Name: "enabled", err: errors.New(`ent: missing required field "Membership.enabled"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
